...
const Cart = () => {
    ...
    const cartPizzas = Object.keys(pizzas).map((key) => {
                ...
                totalCount ? (
                    <div className="cart">
                        ...
                        <div className="content__items">
                            {
                                cartPizzas.map(cartPizza => <CartItem name={cartPizza.name} price={cartPizza.name}
                                                                      imageUrl={cartPizza.imageUrl} id={cartPizza.id}
